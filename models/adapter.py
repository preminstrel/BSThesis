...
from .encoder_decoder import get_task_head
...
class conv1x1(nn.Module):
    ...
    def __init__(self, mode, planes, out_planes=None, stride=1):
...
class conv_task(nn.Module):
    ...
    def __init__(self, mode, in_planes, planes, stride=1, nb_tasks=1, is_proj=1, second=0):
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, shortcut=0, nb_tasks=1):
        ...
        self.conv2 = nn.Sequential(nn.ReLU(True), conv_task(planes, planes, 1, nb_tasks, second=1))
...
class ResNet(nn.Module):
    def __init__(self, data, block, nblocks):
        ...
        self.decoder = get_task_head(data, input=256)
    ...
    def _make_layer(self, block, planes, nblocks, stride=1, nb_tasks=10):
        shortcut = 0
