...
import config_task
from .adapter import get_task_head, get_task_loss
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.adapter = nn.ModuleList([conv3x3(width, width, stride, groups, dilation) for i in range(10)])
...
#         self.fc = nn.Linear(512 * block.expansion, num_classes)
        ...
        self.linears = get_task_head(input=2048, data="TAOP, APTOS, DDR, AMD, LAG, PALM, REFUGE, ODIR-5K, RFMiD, DR+")
    ...
    def forward(self, x):
        ...
        x = self.linears[str(config_task.task)](x)
